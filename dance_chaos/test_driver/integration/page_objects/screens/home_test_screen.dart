...
import '../elements/profile_actions_element.dart';
...
class HomeTestScreen extends TestScreen {
  ...
  final _profileButtonFinder = find.byValueKey('__profileButton__');
  ...
  ProfileActionsElement tapProfileButton() {
    driver.tap(_profileButtonFinder);

    return ProfileActionsElement(driver);
  }
